...
class SessionRecorder {
  ...
  Future<List<File>> getRecords({required DateTime startTime, required DateTime endTime}) {
    return _directoryManager.getRange(startTime: startTime, endTime: endTime).map((e) => e.file).toList();
  }
}
