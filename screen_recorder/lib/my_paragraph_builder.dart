...
extension ExtDynamicUint8ListParagraphBuilder on DynamicUint8List {
  void addParagraphStyle(ParagraphStyle style) {
    addAll(style.encoded.buffer.asUint8List()); // Int32List
    ...
    // if (style.locale != null) addAll(style.locale!); // Locale? // TODO
  ...
  void addTextStyle(TextStyle style) {
    ...
    // if (style.fontFamilyFallback != null) addAll(style.fontFamilyFallback!); // List<String>? // TODO
    if (style.fontSize != null) addDouble(style.fontSize!); // double?
    ...
    // TODO
    // if (style.shadows != null) addAll(style.shadows!); // List<Shadow>?
    // if (style.fontFeatures != null) addAll(style.fontFeatures!); // List<FontFeature>?
    // if (style.fontVariations != null) addAll(style.fontVariations!); // List<FontVariation>?
