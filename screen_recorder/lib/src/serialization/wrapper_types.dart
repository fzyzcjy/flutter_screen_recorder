...
T fromBytesReferable<T>(ContextBytesReader reader, T Function() fromBytesInner) {
  return TODO;
}

void toBytesReferable<T>(ContextBytesWriter writer, T value, void Function() toBytesInner) {
  TODO;
}
